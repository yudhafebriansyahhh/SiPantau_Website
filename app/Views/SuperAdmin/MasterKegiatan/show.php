        ...
        <table class="w-full">
            <thead>
                <tr class="border-b border-gray-200">
                    ...
                    <th class="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider w-28">Satuan</th>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center justify-center space-x-2">
                                    ...
                                    <button onclick="confirmDeleteDetail(<?= $detail['id_kegiatan_detail'] ?>, '<?= esc($detail['nama_kegiatan_detail'], 'js') ?>')"
    ...
    <?php if (!empty($kegiatanDetails)): ?>
        <div class="mt-6">
            <p class="text-sm text-gray-600">
                Total <span class="font-medium"><?= count($kegiatanDetails) ?></span> kegiatan detail
            </p>
        </div>
    <?php endif; ?>
</div>
