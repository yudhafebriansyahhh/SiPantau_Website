...
<div class="mb-6">
    <div class="flex items-center mb-2">
        <a href="<?= base_url('superadmin/kelola-pengguna') ?>" class="text-gray-600 hover:text-gray-900 transition-colors">
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            if ($kegiatan['role'] === 'PML') {
                                $detailUrl = base_url('superadmin/kelola-pengguna/detail-pml/' . $kegiatan['id']);
                            } else {
                                $detailUrl = base_url('superadmin/kelola-pengguna/detail-pcl/' . $kegiatan['id']);
                            }
                            ?>
