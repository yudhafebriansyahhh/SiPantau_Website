    ...
    <form id="formKegiatanDetail" method="POST" action="<?= base_url('superadmin/master-kegiatan-detail') ?>">
            ...
            <div class="relative">
                <select id="id_kegiatan" 
                    ...
                    <?php if (!empty($masterKegiatans)): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <option value="" disabled>Belum ada data master kegiatan</option>
                    <?php endif; ?>
                </select>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       value="<?= old('periode') ?>"
                       placeholder="Contoh: Q1, Semester 1, Triwulan II"
                       required>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <?php else: ?>
                    <p class="mt-1 text-xs text-gray-500">Tanggal mulai kegiatan (opsional)</p>
                <?php endif; ?>
            </div>
            ...
            <div>
                ...
                <?php else: ?>
                    <p class="mt-1 text-xs text-gray-500">Tanggal selesai kegiatan (opsional)</p>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="mb-6">
            ...
            <textarea id="keterangan" 
                      ...
                      placeholder="Tambahkan keterangan atau catatan tambahan (opsional)"><?= old('keterangan') ?></textarea>
