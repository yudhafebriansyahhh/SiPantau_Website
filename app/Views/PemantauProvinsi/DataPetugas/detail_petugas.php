...
<div class="mb-6">
    <div class="flex items-center mb-2">
        <a href="<?= base_url('pemantau-provinsi/data-petugas') ?>" class="text-gray-600 hover:text-gray-900 transition-colors">
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            if ($kegiatan['role'] === 'PML') {
                                $detailUrl = base_url('pemantau-provinsi/data-petugas/detail-pml/' . $kegiatan['id']);
                            } else {
                                $detailUrl = base_url('pemantau-provinsi/data-petugas/detail-pcl/' . $kegiatan['id']);
                            }
                            ?>
