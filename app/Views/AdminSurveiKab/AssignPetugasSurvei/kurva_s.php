...
<div class="bg-white rounded-lg shadow-sm border border-gray-200">
    ...
    <div class="border-b border-gray-200">
        <nav class="flex -mb-px">
            ...
            <button onclick="switchTab('feedback')" id="tabFeedback" class="tab-button px-6 py-4 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300">
        ...
        <div id="contentFeedback" class="tab-content hidden">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            Berikan feedback kepada PCL terkait kinerja dan laporan mereka.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <form id="feedbackForm" class="space-y-4">
                ...
                <div class="flex justify-end gap-3">
                    <button type="button" onclick="resetFeedback()" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors">
                        Reset
                    </button>
...
document.getElementById('feedbackForm').addEventListener('submit', async function(e) {
    ...
    if (result.success) {
        ...
        Swal.fire({
            icon: 'success',
            title: 'Berhasil!',
            text: result.message || 'Feedback berhasil disimpan',
            confirmButtonColor: '#2563eb',
            timer: 2000,
            showConfirmButton: false
        });
