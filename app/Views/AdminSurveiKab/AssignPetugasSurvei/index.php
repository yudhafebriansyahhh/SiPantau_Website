...
<div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
    ...
    <!-- Search, Filter and Add Button - Single Row -->
    <div class="flex flex-col lg:flex-row gap-3 mb-6">
        ...
        <div class="lg:ml-auto">
            <a href="<?= base_url('adminsurvei-kab/assign-petugas/create') ?>" 
               class="inline-flex items-center justify-center w-full lg:w-auto px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors whitespace-nowrap">
        ...
        <table class="w-full border-collapse" id="assignTable">
            <thead>
                <tr class="bg-gray-50 border-b border-gray-200">
                    ...
                    <th class="px-4 py-3 text-left text-sm font-semibold text-gray-700 border-r border-gray-200">Target PML</th>
                    <th class="px-4 py-3 text-center text-sm font-semibold text-gray-700 border-r border-gray-200">Jumlah PCL</th>
...
.fa-users, .fa-user-friends, .fa-bullseye, .fa-chart-line {
...
.select2-container--default .select2-selection--single {
    height: 2.80rem !important; /* sama dengan h-11 */
}
</style>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (filterKegiatan) {
        ...
        $(filterKegiatan).on('change', function() {
            ...
            // Use replaceState to prevent page jump
            if (selectedValue) {
                window.location.href = '<?= base_url('adminsurvei-kab/assign-petugas') ?>?kegiatan=' + selectedValue;
            } else {
                window.location.href = '<?= base_url('adminsurvei-kab/assign-petugas') ?>';
            }
        });
    }
});
