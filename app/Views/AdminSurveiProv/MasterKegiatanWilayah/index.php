...
<div class="card">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <!-- Add Button -->
        <a href="<?= base_url('master-kegiatan-wilayah/create') ?>" 
        ...
        <table class="w-full" id="kegiatanDetailTable">
            <thead>
                <tr class="border-b border-gray-200 bg-gray-50">
                    ...
                    <th class="px-4 py-3 text-center text-xs font-semibold text-gray-600 uppercase tracking-wider w-24">Realisasi</th>
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td class="px-4 py-4 text-sm text-gray-900">Pencacahan Lahan Sawah</td>
                    ...
                    <td class="px-4 py-4 text-sm text-gray-600">Tahap awal pendataan sawah produktif</td>
                    <td class="px-4 py-4 text-center text-gray-900 font-medium">120 Hektar</td>
                    <td class="px-4 py-4 text-center"><span class="badge badge-success">85</span></td>
                ...
                <tr class="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td class="px-4 py-4 text-sm text-gray-900">Wawancara Rumah Tangga</td>
                    ...
                    <td class="px-4 py-4 text-sm text-gray-600">Survei konsumsi pangan dan non-pangan</td>
                    <td class="px-4 py-4 text-center text-gray-900 font-medium">200 Responden</td>
                    <td class="px-4 py-4 text-center"><span class="badge badge-warning">120</span></td>
                    <td class="px-4 py-4 text-center">
                ...
                <tr class="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td class="px-4 py-4 text-sm text-gray-900">Pendataan Individu</td>
                    ...
                    <td class="px-4 py-4 text-sm text-gray-600">Pendataan populasi di wilayah sulit dijangkau</td>
                    <td class="px-4 py-4 text-center text-gray-900 font-medium">350 Jiwa</td>
                    <td class="px-4 py-4 text-center"><span class="badge badge-success">350</span></td>
                    <td class="px-4 py-4 text-center">
                ...
                <tr class="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td class="px-4 py-4 text-sm text-gray-900">Survei Usaha Mikro</td>
                    ...
                    <td class="px-4 py-4 text-sm text-gray-600">Pendataan usaha kecil di sektor perdagangan</td>
                    <td class="px-4 py-4 text-center text-gray-900 font-medium">500 Unit Usaha</td>
                    <td class="px-4 py-4 text-center"><span class="badge badge-danger">180</span></td>
                    <td class="px-4 py-4 text-center">
                ...
                <tr class="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td class="px-4 py-4 text-sm text-gray-900">Pencatatan Harga Pasar</td>
                    ...
                    <td class="px-4 py-4 text-sm text-gray-600">Pemantauan harga bahan pokok di pasar tradisional</td>
                    <td class="px-4 py-4 text-center text-gray-900 font-medium">150 Komoditas</td>
                    <td class="px-4 py-4 text-center"><span class="badge badge-warning">95</span></td>
                    <td class="px-4 py-4 text-center">
