...
<div class="mb-6">
  ...
  <p class="text-gray-600 mt-1">Selamat datang di SiPantau - <?= esc($kabupaten['nama_kabupaten'] ?? 'Kabupaten') ?></p>
</div>
  ...
  <div class="lg:col-span-2 card">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-3">
      <div>
        ...
        <p class="text-sm text-gray-600">Progres Kumulatif Kegiatan - <?= esc($kabupaten['nama_kabupaten']) ?></p>
      </div>
