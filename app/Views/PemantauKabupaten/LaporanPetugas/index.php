                        ...
                        ?>
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="col-nama sticky bg-white px-4 py-3 text-sm border-r border-gray-200">
                                    <a href="<?= base_url('pemantau-kabupaten/laporan-petugas/detail/' . $petugas['id_pcl']) ?>" class="block hover:bg-gray-50 -mx-4 -my-3 px-4 py-3 transition-colors duration-150">
